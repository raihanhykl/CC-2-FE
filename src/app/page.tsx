    ...
    <>
      <div className=" w-full">
        <div className=" w-[100%] max-w-screen-2xl my-1 relative mx-auto h-fit">
          ...
          <div className=" flex flex-col justify-center absolute top-[25%] left-[25%] w-[50%] sm:top-[35%] sm:left-[30%]">
            <h1 className=" tracking-wider text-[12px] font-bold text-left sm:text-[20px] lg:text-[50px] ">
              AutoMax Detailing
            </h1>
            <h3 className="  text-[4px] sm:text-[12px] lg:text-[20px]">
              "Elevating Excellence in Auto Care"
            </h3>
            <p className="  font-light text-[4px] sm:text-[8px] lg:text-[16px] text-justify lg:mt-2">
            ...
            <button className=" bg-black text-white border-[1px] border-white w-fit px-2 py-1 rounded-[50px] text-[4px] sm:text-[8px] lg:text-[16px] mt-4 hover:bg-white hover:text-black hover:border-black">
              Book an Appointment
            </button>
          </div>
        </div>
